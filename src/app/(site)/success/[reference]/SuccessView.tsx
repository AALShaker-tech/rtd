    ...
    <div className="luxe-container max-w-2xl py-14 md:py-20">
      <div className="luxe-card overflow-hidden">
        <div className="lux-dark p-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-ivory/70">
            {pick(t.success.message)}
          </p>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mb-5 flex items-center justify-between rounded-luxe bg-ivory-warm p-4">
            <span className="text-sm font-medium text-charcoal">
              {pick(t.pricing.estimatedTotal)}
            </span>
            <span className="font-serif text-2xl font-semibold text-gold-dark">
              {formatPrice(props.estimatedTotal, locale)}
            </span>
          </div>
          <p className="-mt-3 mb-5 text-center text-xs text-charcoal/45">
            {pick(t.pricing.finalNote)}
          </p>
